 ...
 */
export const getNewsSources = async (country = null, category = null) => {
  try {
    ...
    return json.data?.sources || json.sources || json.data || [];
  } catch (error) {
 ...
 */
export const refreshNewsCache = async (country = null, category = null, language = null) => {
  try {
    ...
    return {
      ...
      message: json.message || 'Cache refresh completed',
      data: json.data || null,
    };
  } catch (error) {
